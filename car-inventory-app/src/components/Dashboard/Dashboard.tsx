...
//Interface for a way to track location of user on the page, i.e. history, location, match
interface DashProps{
...
export const Dashboard = withRouter( (props:DashProps) => {
    console.log(props) //used to error check/verify props are being treated correctly
